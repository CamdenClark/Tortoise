  ...
  object NormalReporter {
    def unapply(r: Reporter): Option[String] =
      PartialFunction.condOpt(r) {
        ...
        case _: Optimizer._anyother   => "SelfPrims.anyOther"
        case _: Optimizer._countother => "SelfPrims.countOther"
  ...
  object NormalCommand {
    def unapply(c: Command): Option[String] =
      PartialFunction.condOpt(c) {
        ...
        case _: Optimizer._fdlessthan1           => "SelfManager.self().fdLessThan1"
